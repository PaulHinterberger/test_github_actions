...
import {SchnappNachsprechenRueckwaertsExercise} from 'src/app/classes/exercises/schnappNachsprechenRueckwaertsExercise';
import {HttpClient} from '@angular/common/http';
import {SmartAudioService} from 'src/app/services/smart-audio.service';
import {DebugModeComponent} from '../../../common-components/debug-mode/debug-mode.component';

@Component({
  selector: 'app-schnapp-nachsprechen-rueckwaerts',
  templateUrl: './schnapp-nachsprechen-rueckwaerts.page.html',
  styleUrls: ['./schnapp-nachsprechen-rueckwaerts.page.scss'],
})
export class SchnappNachsprechenRueckwaertsPage implements OnInit {
  nextPagePressed = false;
  exercise = new SchnappNachsprechenRueckwaertsExercise();
  lines: String[];
  headline = 'Übung';
  ...
  ngOnInit() {
    this.exercise.route = 'schnapp-nachsprechen-rueckwaerts';
    this.data.setExerciseProperties(this.exercise);
    this.smartAudio.sounds = [];
    this.smartAudio.preload('instruction9_1', 'assets/schnapp/schnapp-nachsprechen-rueckwaerts/audioFiles/File_50_NEU_PA_rueckwaerts_merken_Instruktion.mp3');
    this.smartAudio.play('instruction9_1');
    this.sourceLoader.get('assets/schnapp/schnapp-nachsprechen-rueckwaerts/stringResources/res_text.csv', {responseType: 'text'})
      .subscribe(data => {
