...
@Component({
  selector: 'app-gralev-second-text',
  templateUrl: './gralev-second-text.page.html',
  styleUrls: ['./gralev-second-text.page.scss'],
})
export class GralevSecondTextPage implements OnInit {
