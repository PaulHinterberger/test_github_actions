...
@Component({
  selector: 'app-gralev-third-text',
  templateUrl: './gralev-third-text.page.html',
  styleUrls: ['./gralev-third-text.page.scss'],
})
export class GralevThirdTextPage implements OnInit {
