...
@Component({
  selector: 'app-gralev-first-text',
  templateUrl: './gralev-first-text.page.html',
  styleUrls: ['./gralev-first-text.page.scss'],
})
export class GralevFirstTextPage implements OnInit {
  ...
  exercise;
    ...
    initAudio(){
        this.smartAudio.replaceSound('instr', 'assets/gradig/audio/7_Abschluss.mp3')
        //this.smartAudio.preload('instr', 'assets/gradig/audio/7_Abschluss.mp3');
    }
